...
**to be developed**: econometrics is interdiscplinary study involving economics, statistics, operational research, and computational science.
...
For basic matrix manupulation, the default behavior of `numpy` is different from R.
