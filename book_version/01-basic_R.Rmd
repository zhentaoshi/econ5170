...
Another example about the relationship between the height and weight of women.
The women dataset is from the package `datasets`, which is a bulit-in package and supposed to have been downloaded automaticly with R installation. This package contains a variety of datasets. For a complete list, use `library(help = "datasets")`

```{r}
# univariate
a<-lm(height~weight, data=women)

# multivariate 
b<-lm(height~weight+I(weight^2),data=women)
