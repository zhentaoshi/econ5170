...
There are two way to interact with Git. Git provides a command line tool Git Bash,
...
* `git branch -d branch_name` delete a branch from the project
...
* `git pull`
* `git fetch` brings updates down to a local copy. **Note:** This command will not merge changes from the remote into your local repository. It brings those changes onto what's called a remote branch.


The workflow for Git collaboration typically follows this order:
