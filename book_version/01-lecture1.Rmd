...
The most basic object in R is a vector. A vector can be a collection of integers, Boolean values, real numbers, complex numbers, characters and factor. We use  `<-` to assign the value on the right-hand side to the object
on the left-hand side. We use `c()` to combine two or more vectors into a single vector.
