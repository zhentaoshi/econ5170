...
Why not Python? Python is a general purpose language, not a scientific computing langauge. We need to load extra numerical packages every time we use Python.
