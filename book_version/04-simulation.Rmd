...
In the real world, all sample is finite. The distribution of a statistic in finite sample depends on 
the sample size $n$, which has simple mathematical expression only in rare cases. Fortunately, 
such expressions can often be simplified when we imagine the sample size being arbitrarily large. 
