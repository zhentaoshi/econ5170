...
However, there are only a small handful of major ideas.
...
until $|\theta_{t+1} -\theta_{t}| < \epsilon$, where $\epsilon$ is a small positive number chosen as the tolerance level.
