...
If $y_i$ is a continuous random variable, it obviously does not follow a possion
distribution, whose support consists of non-negative integers. However, if the conditional mean model
$$E[y_i | x_i] = \exp( x_i' \beta),$$
is satisfied, we can still use the possion regression to obtain a consistent
