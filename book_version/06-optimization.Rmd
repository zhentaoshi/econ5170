...
A survey and demonstration paper can be found here [@gao2018two].


* Convex solvers: CLEPX, MOSEK, Gurubi, (Commercial)   EOS, SDPT3, (free)
* `CVX` is a convex modeling language, and its has its R version.
