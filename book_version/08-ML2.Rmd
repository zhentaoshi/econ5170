...
Regression tree [@breiman1984classification] is an alternative method. It  recursively partitions the
...
For example, the script `Beijing_housing_gbm.R` achieves 96% out-of-sample $R^2$ (in comparison with OLS's 84%) in the Beijing housing data.
