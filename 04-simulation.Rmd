...
the error term is normal, the numerator of the above expression follows a normal distribution and the demonimator follows a $\chi^2$, and moreover these two components are independent.
