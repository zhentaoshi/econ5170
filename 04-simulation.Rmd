...
Standing on the shoulder of laws of large numbers, $\pi$ can be approximated by a stochastic algorithm.
...
but ignore the estimated variance. (This is a lazy option. However, if we manually program the point estimation, they must produce the same result.)
