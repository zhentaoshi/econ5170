...
indirect inference, and Markov Chain Monte Carlo. These methods are beyond the 
...
Some symbolic software, say `Mathematica` or `Wolfram Alpha`, is a useful tool for this purpose. R is weak in symbolic calculation despite the existence of a few packages
for this purpose.
...
In the original paper of the Roy model, an economic agent can work on one of the two occupations: farming or fishing.
...
Indirect inference is extensively used in structural model estimatoin [@li2010indirect]. 
...
The underlying theory of the MH requies long derivation, but implementation is straightforward.
